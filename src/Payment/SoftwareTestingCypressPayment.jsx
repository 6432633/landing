...
const SoftwareTestingCypressProPayment = () => {
        ...
        <div>
            ...
            <div>
                <div className="header">
                    <div className="text">Enroll To Software Testing(Cypress) Pro Course</div>
                ...
                <div className="inputs">
                    <div className="input">
                        <input
                            ...
                            readOnly
                            value="Software Testing(Cypress) Pro"
                        />
                    </div>
                    <div className="input">
                    ...
                    <div className="input">
                        <input type="text" name="price" style={{ paddingLeft: '10px' }} value={`50 $`} readOnly />
                    </div>
...
export default SoftwareTestingCypressProPayment