...
const SoftwareTestingJavaPayment = () => {
        ...
        <div>
            ...
            <div>
                <div className="header">
                    <div className="text">Enroll To Software Testing(Java) Course</div>
...
export default SoftwareTestingJavaPayment